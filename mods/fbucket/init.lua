...
minetest.register_alias("bucket", "fbucket:bucket_empty")
minetest.register_alias("bucket_water", "fbucket:bucket_water")
minetest.register_alias("bucket_lava", "fbucket:bucket_lava")
--[[
...
function fbucket.register_liquid(source, flowing, itemname, inventory_image, name,
		groups, force_renew)
	fbucket.liquids[source] = {
		source = source,
		flowing = flowing,
		itemname = itemname,
		force_renew = force_renew,
	}
	fbucket.liquids[flowing] = fbucket.liquids[source]
	...
	if itemname ~= nil then
		minetest.register_craftitem(itemname, {
			...
			on_place = function(itemstack, user, pointed_thing)
				...
				return ItemStack("fbucket:bucket_empty")
			end
		})
	end
end
...
minetest.register_craftitem("fbucket:bucket_empty", {
	...
	on_use = function(itemstack, user, pointed_thing)
		...
		local liquiddef = fbucket.liquids[node.name]
		...
		and node.name == liquiddef.source then
			...
			if item_count > 1 then
				...
				giving_back = "fbucket:bucket_empty "..tostring(item_count-1)
