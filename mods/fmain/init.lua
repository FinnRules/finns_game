...
dofile(fmain.path .. "/geothermal_furnace.lua")
dofile(fmain.path .. "/nuclear_reactor.lua")
dofile(fmain.path .. "/forge.lua")
dofile(fmain.path .. "/cf_craft.lua")
dofile(fmain.path .. "/oven.lua")
dofile(fmain.path .. "/decorations.lua")
dofile(fmain.path .. "/tools.lua")
